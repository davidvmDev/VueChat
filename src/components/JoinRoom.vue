  ...
  <b-row>
    ...
    <b-col cols="6" align-self="center">
      ...
      <b-form @submit="onSubmit">
        ...
        <b-button type="submit" variant="primary">Unirse</b-button>
      </b-form>
    </b-col>
  ...
  methods: {
    onSubmit (evt) {
      ...
      axios.post(`http://localhost:3000/api/chat`, this.chat)
        .then(response => {
          this.socket.emit('save-message', { room: this.chat.room, nickname: this.chat.nickname, message: 'Entró a la sala', created_date: new Date() });
          this.$router.push({
            name: 'ChatRoom',
